...
export default function App() {
  ...
  return {/* FIX 1: overflow-x-hidden on the root wrapper prevents any child from causing horizontal scroll */}
    <div className="min-h-screen flex flex-col selection:bg-wood-dark selection:text-white overflow-x-hidden">
      {/* Marquee Ticker */}
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start gap-16">
            <motion.div 
              ...
              className="flex-1 space-y-10 text-center lg:text-left w-full"
            >
              ...
              {/* FIX 2: Clamp huge font size — was text-[11rem] which overflows on mobile */}
              ...
              <p className="font-serif text-xl md:text-3xl opacity-80 max-w-2xl italic leading-relaxed pt-4">
              ...
              <div className="pt-10 flex flex-wrap gap-6 justify-center lg:justify-start">
                <a href="#specials" className="bg-white text-black px-8 sm:px-12 py-5 uppercase text-xs tracking-widest font-black hover:bg-amber-100 transition-all flex items-center gap-2 rounded-sm shadow-2xl">
                  <ForkIcon /> Zobacz Specjały
                </a>
                <a href="#contact" className="border border-white/20 px-8 sm:px-12 py-5 uppercase text-xs tracking-widest font-black hover:bg-white/10 transition-all rounded-sm flex items-center gap-2">
            ...
            <motion.div 
              ...
              className="relative w-56 h-56 sm:w-72 sm:h-72 md:w-[450px] md:h-[450px] shrink-0"
            >
      ...
      <main className="bg-[#f5f2ed] relative overflow-x-hidden">{/* FIX 3: overflow-x-hidden on main too */}
        {/* Modern Sticky Nav */}
        ...
        {/* Narrative Section */}
        <section id="about" className="max-w-7xl mx-auto px-6 sm:px-8 py-24 md:py-48">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 items-center">
            ...
            >
              <div className="space-y-6">
                ...
                {/* FIX 4: Reduce oversized font on mobile — was text-[11rem] which overflows */}
                <h2 className="font-display text-5xl sm:text-6xl md:text-8xl italic leading-[0.95] tracking-tight">
                  Smak, który<br /><span className="text-6xl sm:text-8xl md:text-[10rem] not-italic uppercase tracking-tighter">Pamiętasz</span>
                </h2>
              </div>
              <div className="space-y-10 font-serif text-xl md:text-2xl text-gray-800 leading-relaxed opacity-90">
                <p>
              ...
              <div className="grid grid-cols-3 gap-6 sm:gap-12 pt-12 border-t border-black/10">
                {[
                  ...
                  <div key={i} className="group">
                    <div className="text-4xl sm:text-6xl font-display mb-2 group-hover:scale-110 transition-transform origin-left">{stat.val}</div>
                    <div className="text-[9px] sm:text-[10px] uppercase tracking-widest opacity-40 font-black">{stat.label}</div>
                  </div>
                ))}
              </div>
            </motion.div>
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              className="relative" {/* FIX 5: removed negative margins on floating thumbnail that caused overflow */}
            >
              ...
              {/* FIX 6: Floating thumbnail — hidden on xl only, negative margins clipped by parent overflow-hidden */}
              ...
              {/* FIX 7: Rotated label — was position absolute with -right-10, causing overflow. Now hidden on mobile */}
              <div className="absolute top-10 -right-10 px-8 py-4 bg-black text-white text-[10px] uppercase tracking-[0.5em] font-black -rotate-90 origin-right hidden lg:block">
                Prawdziwe Jedzenie
              </div>
            </motion.div>
          </div>
        ...
        {/* Specials Spotlight */}
        <section id="specials" className="max-w-7xl mx-auto px-6 sm:px-8 py-24 md:py-40">
          <div className="flex flex-col md:flex-row justify-between items-end mb-20 md:mb-32 gap-12">
            <div className="space-y-6">
               ...
               {/* FIX 8: Constrain heading size on mobile */}
               <h2 className="font-display text-5xl sm:text-7xl md:text-9xl uppercase tracking-tighter leading-none">Nasze<br />Specjały</h2>
            </div>
            <p className="font-serif text-xl md:text-2xl italic opacity-60 md:text-right max-w-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-black/10 vintage-border overflow-hidden rounded-sm shadow-2xl">
            {[
              ...
              <motion.div 
                ...
                className="p-10 md:p-20 bg-white space-y-8 md:space-y-10 group transition-colors duration-700"
              >
                <div className="text-black group-hover:text-amber-200 transition-colors">
                   {item.icon}
                </div>
                <h3 className="font-display text-3xl md:text-4xl uppercase tracking-tight leading-none">{item.title}</h3>
                <p className="font-serif text-lg md:text-xl opacity-70 leading-relaxed italic">{item.desc}</p>
                <div className="pt-6 md:pt-10 flex items-center gap-4 opacity-0 group-hover:opacity-100 transition-all transform translate-y-4 group-hover:translate-y-0">
        ...
        <section id="jars" className="wood-texture py-32 md:py-48 px-6 sm:px-8 text-white relative shadow-[inset_0_0_200px_rgba(0,0,0,1)] flex flex-col items-center overflow-hidden">
          <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
            <div className="lg:col-span-7 space-y-12 lg:space-y-16">
              <div className="space-y-8">
                ...
                {/* FIX 9: Reduce font on mobile */}
                <h2 className="font-display text-5xl sm:text-7xl md:text-9xl leading-[0.8] tracking-tighter">SMAK NA<br /><span className="italic font-serif normal-case opacity-70">później</span></h2>
              </div>
              <p className="font-serif text-xl md:text-3xl opacity-90 leading-relaxed italic border-l-2 border-white/20 pl-8 md:pl-12">
                "Pstrągi i dorsze w słoikach w zalewie słodko-kwaśnej to nasza autorska produkcja, którą możesz zabrać ze sobą do domu."
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 md:gap-12 font-serif group">
                {[
                  "Prawdziwy Pstrąg",
                  "Dorsz w marynacie",
                  "100% Natury",
                  ...
                  <div key={i} className="flex items-center gap-6 text-xl md:text-2xl group-hover:opacity-50 hover:!opacity-100 transition-opacity cursor-default">
            ...
            <div className="lg:col-span-5 relative group">
              ...
              {/* FIX 10: Rotated label hidden on mobile — was bleeding outside viewport */}
              <div className="absolute top-10 -right-10 px-8 py-4 bg-black text-white text-[10px] uppercase tracking-[0.5em] font-black -rotate-90 origin-right hidden lg:block">
                Prawdziwe Jedzenie
              </div>
            </div>
        ...
        {/* Gallery */}
        <section id="gallery" className="max-w-7xl mx-auto py-24 md:py-40 px-6 sm:px-8">
        ...
        <section className="bg-white py-24 md:py-48">
          <div className="max-w-7xl mx-auto px-6 sm:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-32 items-center">
              <div id="hours" className="lg:col-span-5 space-y-16 md:space-y-20">
                 <div className="space-y-6">
                    <span className="uppercase text-[12px] tracking-[0.7em] opacity-40 font-black">Plan Dnia</span>
                    {/* FIX 11: Reduce massive heading on mobile */}
                    <h2 className="font-display text-5xl sm:text-6xl md:text-7xl lg:text-[8rem] uppercase tracking-tighter leading-[0.8]">Godziny<br />Otwarcia</h2>
                 </div>
                 
                 <div className="space-y-6 md:space-y-8 text-2xl md:text-3xl font-serif">
                   <div className="flex justify-between items-center text-red-700 border-b-2 border-black/5 pb-6 md:pb-8 opacity-50">
                     <span className="italic">Poniedziałek</span>
                     <span className="uppercase tracking-[0.3em] text-[10px] sm:text-[11px] font-black border border-red-700 px-3 py-1">Zamknięte</span>
                   </div>
                   {["Wtorek", "Środa", "Czwartek", "Piątek", "Sobota", "Niedziela"].map(day => (
                     <div key={day} className="flex justify-between items-center border-b border-black/5 pb-6 md:pb-8 group">
                       <span className="group-hover:pl-6 transition-all duration-500">{day}</span>
                       <span className="font-display tracking-[0.2em] text-xl md:text-2xl">11:00 - 18:00</span>
                     </div>
                   ))}
                 </div>
              </div>

              <div id="contact" className="lg:col-span-7 space-y-12 md:space-y-16">
                 <div className="vintage-border h-[400px] md:h-[700px] relative rounded-sm shadow-[50px_50px_100px_rgba(0,0,0,0.05)] overflow-hidden">
                    <iframe 
                 ...
                 <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 md:gap-12 text-center md:text-left">
                    <div className="space-y-4">
                       <p className="text-[10px] uppercase tracking-[0.5em] opacity-40 font-black">Telefonicznie</p>
                       <a href="tel:884747885" className="font-display text-3xl md:text-4xl hover:opacity-50 transition-opacity">884 747 885</a>
                    </div>
                    <div className="space-y-4 text-center sm:text-right">
                       ...
                       <p className="font-display text-3xl md:text-4xl">Szkolna 7,<br />Jaworze</p>
                    </div>
                 </div>
              </div>
            </div>
        ...
        {/* Editorial Reviews */}
        <section className="bg-[#f5f2ed] py-24 md:py-48 border-t border-black/5">
           <div className="max-w-7xl mx-auto px-6 sm:px-8">
              <div className="max-w-2xl mx-auto text-center mb-20 md:mb-32 space-y-8">
                 <div className="flex justify-center gap-3">
                    {[...Array(5)].map((_, i) => <Star key={i} size={20} fill="black" />)}
                 </div>
                 <h2 className="font-display text-5xl md:text-6xl italic leading-tight">Co mówią nasi<br />stali goście</h2>
              ...
              <div className="columns-1 md:columns-2 lg:columns-3 gap-16 space-y-16">
                {reviews.map((rev, idx) => (
                  <motion.div 
                    ...
                    initial={{ opacity: 0, y: 30 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    className="break-inside-avoid p-10 md:p-16 vintage-border bg-white border-black/5 hover:translate-y-[-10px] transition-all duration-500 rounded-sm shadow-xl"
                  >
                    <Quote className="opacity-10 mb-8" size={64} strokeWidth={1} />
                    <p className="font-serif italic text-lg md:text-xl leading-relaxed mb-12 opacity-90 group-hover:text-black transition-colors text-justify">
                       "{rev.text}"
                    </p>
              ...
              <div className="text-center mt-20 md:mt-32">
                <a 
                   ...
                   target="_blank" 
                   rel="no-referrer"
                   className="inline-block px-10 sm:px-12 py-6 bg-black text-white uppercase text-[11px] tracking-[0.5em] font-black hover:bg-gray-800 transition-all rounded-sm shadow-2xl"
                 >
      ...
      <footer className="wood-texture py-24 md:py-40 px-6 sm:px-8 text-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col items-center gap-16 md:gap-24 relative z-10">
          <div className="text-center space-y-10">
            ...
            {/* FIX 12: Footer heading constrained on mobile */}
            <h3 className="font-display text-5xl sm:text-7xl md:text-9xl uppercase tracking-[0.2em] leading-none">Do<br />Usłyszenia</h3>
            <p className="font-serif text-2xl md:text-3xl opacity-50 italic">Czekamy na Ciebie w Smażalnia Jaworze.</p>
          </div>
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-20 text-center md:text-left font-serif">
             <div className="space-y-6">
                ...
                <p className="text-2xl md:text-3xl font-display">ul. Szkolna 7<br />43-384 Jaworze</p>
             </div>
             ...
             <div className="space-y-6 text-center md:text-right">
                ...
                <p className="text-2xl md:text-3xl font-display">884 747 885</p>
                <p className="opacity-60 text-xl">smazalniajaworze@gmail.com</p>
             </div>
          </div>

          <div className="pt-16 md:pt-24 space-y-6 opacity-20 hover:opacity-50 transition-opacity">
             <div className="w-16 h-[1px] bg-white mx-auto" />
             <p className="text-[10px] uppercase tracking-[0.8em] font-black text-center">
